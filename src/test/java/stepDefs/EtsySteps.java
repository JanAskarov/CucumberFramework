...
public class EtsySteps {
    ...
    public void user_clicks_on_Free_Shipping_checkbox() throws Throwable {
       ...
       // BrowserUtils.hover(etsyResultPage.freeShippingBox,Driver.driver);

        etsyResultPage.freeShippingBox.click();
        Thread.sleep(5000);
    ...
    @Then("^User verify all resulrs have \"([^\"]*)\" label$")
    public void user_verify_all_resulrs_have_label(String label) throws Throwable {
